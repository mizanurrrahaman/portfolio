...
const ResumeCarde = ({title, subTitle, result, des}) => {
  return (
       ...
       <div className="w-10 h-[6px] bgOpacity mt-16 relative">
         ...
         <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg px-10 flex flex-col justify-center gap-10 shadow-shadowOne">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h3 className="text-2xl font-semibild group-hober:text-white duration-300">{title} 
                    </h3>
                ...
                <div>
                   <p className="w-20 h-10 text-desingnColor bg-black bg-opacity-25 rounded-lg flex justify-center items-center shadow-shadowOne text-sm font-medium">{result}</p>
                </div>
            </div>
