      ...
      <div className="w-full h-[80%] overflow-hidden rounded-lg">
       ...
       <div className="w-full mt-5 flex flex-col gap-6">
         <div className="flex item-center justify-between">
            <h3 className="text-2xl text-red-600 font-medium">{title}</h3>
            <div className="flex gap-2">
                <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-red-600 duration-cursor-pointer">
                  <BsGithub/>
                </span>
                <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-red-600 duration-cursor-pointer">
                  <FaGlobe/>
